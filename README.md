...
This is the code that I wrote for team game project for my Digipen Masters program. This code doesn't compile or run anymore (for one because we used XNA, RIP, but also because I've only included the code that I wrote), I just have it here as an example of my work (albeit from 2010).
